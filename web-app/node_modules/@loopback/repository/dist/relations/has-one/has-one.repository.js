...
class DefaultHasOneRepository {
    ...
    async patch(dataObject, options) {
        const targetRepository = await this.getTargetRepository();
        return await targetRepository.updateAll(repositories_1.constrainDataObject(dataObject, this.constraint), repositories_1.constrainWhere({}, this.constraint), options);
    }
}
